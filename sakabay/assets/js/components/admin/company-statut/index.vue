  ...
  <div class="container-fluid skb-body">
    ...
    <div class="row my-4">
      ...
      <div
        ...
        class="col-1"
      >
        <a href="/admin/company-statut/new">
        ...
        >
          <template #cell(actions)="data">
            <b-button-group>
              <a
                v-if="canRead"
                :href="'/admin/company-statut/show/' + data.value "
              >
                <b-button><font-awesome-icon :icon="['fas', 'eye']" /></b-button>
              </a>
              <a
                v-if="canEdit"
                :href="'/admin/company-statut/edit/' + data.value "
                class="mx-1"
              >
    ...
    <confirm-modal
      ...
      @confirm-modal-yes="$deleteEntity('/api/admin/company-statuts/')"
    />
  </div>
</template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        table: {
          field: [
            { key: 'name', label: this.$t('company_statut.fields.name'), sortable: true, thClass: 'tableitem' },
            { key: 'code', label: this.$t('company_statut.fields.code'), sortable: true, thClass: 'tableitem' },
    ...
    methods: {
      refreshData() {
        this.loading = true;
        return axios.get('/api/admin/company-statuts', {
          params: {
