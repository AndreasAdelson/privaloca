  ...
  <div class="container-fluid skb-body">
    ...
    <div class="row my-4">
      ...
      <div
        ...
        class="col-1"
      >
        <a href="/admin/sous-category/new">
    ...
    <confirm-modal
      ...
      @confirm-modal-yes="$deleteEntity('/api/admin/sous-categories/')"
    />
  </div>
</template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        table: {
          field: [
            { key: 'name', label: this.$t('sous_category.fields.name'), sortable: true, thClass: 'tableitem' },
            { key: 'code', label: this.$t('sous_category.fields.code'), sortable: true, thClass: 'tableitem' },
            { key: 'category', label: this.$t('sous_category.fields.category'), sortable: false, thClass: 'tableitem' },
    ...
    methods: {
      refreshData() {
        ...
        return axios.get('/api/admin/sous-categories', {
          ...
          let items = _.map(response.data, sousCategory => _.assign(sousCategory, {
            code: sousCategory.code,
            name: sousCategory.name,
            category: sousCategory.category ? sousCategory.category.name : '' ,
            actions: sousCategory.id,
          }));
